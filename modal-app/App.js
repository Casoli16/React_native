...
const App = () => {
  ...
  const agregarCliente = () => {
    ...
    const nuevoCliente = { id: count, nombre: nombre, cantidad: cantidad, fechaReserva: fechaReserva };
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            ...
            <Text style={styles.clienteFecha}>
              Cantidad de personas: {item.cantidad.toString()}
            </Text>
            <Button title='Eliminar reserva' color='red' onPress={() => eliminarCliente(item.id)}></Button>
          </View>
        )}
